    ...
    def _capture_loop(self):
        ...
        while self.is_running:
            ...
            while self.is_running and self.cap.isOpened():
                ...
                # Removed time.sleep(0.01) here.
                # Sleeping in a live RTSP read loop causes OpenCV's internal buffer to overflow,
                # resulting in dropped packets, gray tearing, and "multicolor" frame corruption.
